...
SECRET_KEY = '6mb49k1w%m&)tun3@u$(0(!ud0)ms*0e%g0dwdvt5f(tv0g83q'
...
MIDDLEWARE_CLASSES = (
    'alkawsarsite.middleware.DomainMiddleware',
...
INSTALLED_APPS = (
    ...
    'alkawsarsite.authors',
    'alkawsarsite.sections',
    'alkawsarsite.issues',
